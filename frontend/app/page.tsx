...
const features = [
  {
    ...
    description: "Connect with alumni from your university and expand your professional network.",
    icon: "👥"
  },
  {
    title: "Mentorship",
    description: "Find mentors who can guide you in your career or become a mentor to help others.",
    icon: "🎓"
  },
  {
    title: "Job Opportunities",
    description: "Discover job postings from alumni companies and apply directly through the platform.",
    icon: "💼"
  },
  {
    title: "Events",
    description: "Stay updated with university events, workshops, and networking sessions.",
    icon: "📅"
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span className="text-xl font-bold text-blue-600">ReUnion</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-blue-600">Students & Alumni</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Join our platform to connect with your university community, find mentors, discover job opportunities, and stay updated with events.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides all the tools you need to maintain your university connections throughout your career.
            </p>
          </div>
      ...
      <div className="bg-blue-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-200">
            Sign up now and start connecting with your fellow alumni and students today.
          </p>
          <Link 
            href="/signup" 
